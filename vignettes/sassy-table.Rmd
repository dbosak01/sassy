...
Note the following about this example:
  ...
  * The **[logr](http://logr.r-sassy.org)** package combined with **tidylog** 
  provides automatic logging for **dplyr** and **tidyr** functions.
  * The `datastep()` function from the **[libr](http://libr.r-sassy.org)**
  ...
  * The **[fmtr](http://fmtr.r-sassy.org)** package provides several 
  ...
  * The **[reporter](http://reporter.r-sassy.org)** package supports 
...
Next: [Example 3: Table](https://sassy.r-sassy.org/articles/sassy-figure.html)
