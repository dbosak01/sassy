---
title: "Example 13: AE Severity in Rows"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Example 13: AE Severity in Rows}
...
```
The 13th example is similar to the Adverse Events table produced in Example 4.
...
rpt <- create_report(file.path(tmp, "example13.rtf"), output_type = "RTF", 
...
- file_path: 'C:\Users\dbosa\AppData\Local\Temp\Rtmp4q58ap/example13.rtf'
- output_type: RTF
- units: inches
